		...
		<div class="page-content form-page">
			...
			<div class="bg-dash-dark-2 py-4">
				<div class="container-fluid">
					<h2 class="h5 mb-0">View Operator</h2>
				</div>
			</div>
			<!-- Breadcrumb-->
				...
				<div class="row gy-4">
					...
					<div class="card mb-0">
						<div class="card-header">
							<h3 class="h4 mb-0">List of all Operators</h3>
						</div>
									...
									<tbody>
										<c:forEach items="${operatorList}" var="operator">
											<tr class="dataRow">
												...
												<td>${operator.territoryid}</td>
												<td>${operator.initials}</td>
												<td><form action="editOperator" method="post">
														<button type="submit" class="btn btn-primary"
															name="operatorId" value="${operator.id}">Edit</button>
													</form></td>
											</tr>
										</c:forEach>
									</tbody>
