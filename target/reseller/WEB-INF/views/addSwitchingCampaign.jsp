...
<title>Add Switching Campaign</title>
		...
		<div class="page-content form-page">
			...
			<div class="bg-dash-dark-2 py-4">
				<div class="container-fluid">
					<h2 class="h5 mb-0">Add Switching Campaign</h2>
				</div>
			</div>
			<!-- Breadcrumb-->
