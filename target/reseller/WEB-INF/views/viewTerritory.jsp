		...
		<div class="page-content form-page">
			...
			<div class="bg-dash-dark-2 py-4">
				<div class="container-fluid">
					<h2 class="h5 mb-0">View Territory</h2>
				</div>
			</div>
			<!-- Breadcrumb-->
				...
				<div class="row gy-4">
					...
					<div class="card mb-0">
						<div class="card-header">
							<h3 class="h4 mb-0">List of all Territories</h3>
						</div>
								...
								<table class="table mb-0 table-striped table-hover"
									...
									<tbody>
										<c:forEach items="${territoryList}" var="territory">
											<tr class="dataRow">
												<th scope="row">${territory.id}</th>
												<td>${territory.name}</td>
												<td>${territory.status}</td>
												<td>${territory.initials}</td>
												<td><form action="editTerritory" method="post">
														<button type="submit" class="btn btn-primary"
															name="territoryId" value="${territory.id}">Edit</button>
													</form></td>
											</tr>
										</c:forEach>
										<!-- <tr>
