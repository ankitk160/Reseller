...
<title>Edit Switching Campaign</title>
...
<body>
		...
		<div class="page-content form-page">
			...
			<div class="bg-dash-dark-2 py-4">
				<div class="container-fluid">
					<h2 class="h5 mb-0">Edit Switching Campaign</h2>
				</div>
			</div>
			<!-- Breadcrumb-->
					...
					<div class="col-lg-12">
						...
						<div class="card">
							...
							<div class="card-body pt-0">
								<form class="form-horizontal" action="updateSwitchingCampaign"
									method="post">
									<div class="row">
										<label class="col-sm-3 form-label">Switching Name</label>
										<div class="col-sm-9">
											<input class="form-control" type="text" name="switchingName"
												placeholder="Enter Switching Name Here..."
												value="${switchingCampaign.switchingName}" required>
										</div>
									</div>
									<input type="hidden" name="id" value="${switchingCampaign.id}">
									<div class="my-4"></div>
									<div class="row">
										<label class="col-sm-3 form-label">Select Territory ID</label>
										<div class="col-sm-9">
											<select class="form-select mb-3" id="territoryid1" required>
									...
									<div class="row">
										...
										<div class="col-sm-9">
											<select class="form-select mb-3" id="promoterName1" required>
												<option selected="selected">-Select Promoter-</option>
												<c:forEach items="${promoterList}" var="promoter">
													<option value="${promoter.name}">${promoter.id}-
									...
									<div class="my-2"></div>
									<div class="row">
										<label class="col-sm-3 form-label">Select App Traffic
											Service Info</label>
										<div class="col-sm-9">
											<select class="form-select mb-3" name="switchingCampId"
												id="appTSInfo1" required>
											</select>
										</div>
									</div>
									<div class="my-2"></div>
									<div class="row">
										<label class="col-sm-3 form-label">Switching Campaign
											Capacity</label>
										<div class="col-sm-9">
											<input class="form-control" type="text"
												name="switchingCampCap"
												value="${switchingCampaign.switchingCampCap}"
												placeholder="Enter Switching Campaign Capacity Here..."
												required>
										</div>
									</div>
									<div class="my-2"></div>
									<div class="row">
										<label class="col-sm-3 form-label">First Level
											Switching</label>
										<div class="col-sm-9">
											<div class="form-check form-switch">
												<input class="form-check-input" type="checkbox"
													...
													id="switchBaseCampaignFlag" name="switchBaseCampaignFlag">
											</div>
										</div>
										<div class="collapse" id="collapseExample1">
											<div class="card card-body">
												<div class="row">
													<label class="col-sm-3 form-label">Select Territory
														ID</label>
													<div class="col-sm-9">
														<select class="form-select mb-3" id="territoryid2">
															<option selected="selected">-Select Territory-</option>
															<c:forEach items="${territoryList}" var="territory">
																<option value="${territory.id}">${territory.id}-
																	${territory.name}</option>
												...
												<div class="my-1"></div>
												<div class="row">
													<label class="col-sm-3 form-label">Select Operator
														ID</label>
													<div class="col-sm-9">
														<select class="form-select mb-3" id="operatorid2">
														</select>
													</div>
												</div>
												<div class="my-1"></div>
												<div class="row">
													<label class="col-sm-3 form-label">Select Promoter</label>
													<div class="col-sm-9">
														<select class="form-select mb-3" id="promoterName2">
															<option selected="selected">-Select Promoter-</option>
															<c:forEach items="${promoterList}" var="promoter">
																<option value="${promoter.name}">${promoter.id}-
																	${promoter.name}</option>
												...
												<div class="my-1"></div>
												<div class="row">
													<label class="col-sm-3 form-label">Select App
														Traffic Service Info</label>
													<div class="col-sm-9">
														<select class="form-select mb-3" name="switchingCampId_1"
															id="appTSInfo2">
														</select>
													</div>
												</div>
												<div class="my-1"></div>
												<div class="row">
													<label class="col-sm-3 form-label">Switching
														Campaign Capacity</label>
													<div class="col-sm-9">
														<input class="form-control" type="text"
															value="${switchingCampaign.switchingCampCap_1}"
															name="switchingCampCap_1" id="switchingCampCap_1"
															placeholder="Enter Switching Campaign Capacity Here...">
													</div>
												</div>
											</div>
									...
									<div class="my-1"></div>
									<div class="row">
										<label class="col-sm-3 form-label">Second Level
											Switching</label>
										<div class="col-sm-9">
											<div class="form-check form-switch">
												<input class="form-check-input" type="checkbox"
													...
													name="switchCampaignFlag_1" id="switchCampaignFlag_1"
													disabled>
											</div>
										</div>
											...
											<div class="card card-body">
												<div class="row">
													<label class="col-sm-3 form-label">Select Territory
														ID</label>
													<div class="col-sm-9">
														<select class="form-select mb-3" id="territoryid3">
															<option selected="selected">-Select Territory-</option>
															<c:forEach items="${territoryList}" var="territory">
																<option value="${territory.id}">${territory.id}-
																	${territory.name}</option>
												...
												<div class="row">
													<label class="col-sm-3 form-label">Select Operator
														ID</label>
													<div class="col-sm-9">
														<select class="form-select mb-3" id="operatorid3">
														</select>
													</div>
												</div>
												<div class="my-1"></div>
												<div class="row">
													<label class="col-sm-3 form-label">Select Promoter</label>
													<div class="col-sm-9">
														<select class="form-select mb-3" id="promoterName3">
															<option selected="selected">-Select Promoter-</option>
															<c:forEach items="${promoterList}" var="promoter">
																<option value="${promoter.name}">${promoter.id}-
																	${promoter.name}</option>
												...
												<div class="row">
													<label class="col-sm-3 form-label">Select App
														Traffic Service Info</label>
													<div class="col-sm-9">
														<select class="form-select mb-3" name="switchingCampId_2"
															id="appTSInfo3">
														</select>
													</div>
												</div>
	...
	<script>
		...
		$('#territoryid1').change(function() {
			var selectedValue = $(this).val();
			getOperator(selectedValue, 1);
		});
		$('#territoryid2').change(function() {
			var selectedValue = $(this).val();
			getOperator(selectedValue, 2);
		});
		$('#territoryid3').change(function() {
			var selectedValue = $(this).val();
			getOperator(selectedValue, 3);
		});

		/* Ajax function for getting operators list */
		function getOperator(selectedTerritoryId, operatorNo) {
			$.ajax({
				type : "POST",
				...
				success : function(result) {
					...
					var operatorid = $("#operatorid" + operatorNo);
					operatorid.empty();
					operatorid.append($("<option>").text("-Select Operator-"));
		...
		$('#promoterName1').change(function() {
			var selectedValue = $(this).val();
			getAppTSInfo(selectedValue, 1);
		});
		$('#promoterName2').change(function() {
			var selectedValue = $(this).val();
			getAppTSInfo(selectedValue, 2);
		});
		$('#promoterName3').change(function() {
			var selectedValue = $(this).val();
			getAppTSInfo(selectedValue, 3);
		});

		/* Ajax function for getting AppTSInfo list */
		function getAppTSInfo(selectedPromoter, num) {
			var selectedOperator = $('#operatorid' + num).val();
			...
			$.ajax({
				...
				success : function(result) {
					var jsonResult = JSON.parse(result);
					var appTSInfo = $("#appTSInfo" + num);
					appTSInfo.empty();
					$.each(jsonResult, function(index, item) {
						var option = $("<option>").val(item.id).text(
								item.id + " - " + item.servicename);
						appTSInfo.append(option);
					});
				}
			});
		}
		...
		const territoryid2 = document.getElementById("territoryid2");
		const operatorid2 = document.getElementById("operatorid2");
		const promoterName2 = document.getElementById("promoterName2");
		...
		switchBaseCampaignFlag.addEventListener("change", function() {
			if (switchBaseCampaignFlag.checked) {
				territoryid2.required = true;
				operatorid2.required = true;
				promoterName2.required = true;
				...
				territoryid2.required = false;
				operatorid2.required = false;
				promoterName2.required = false;
		...
		const switchSecondLevel = document
				.getElementById("switchCampaignFlag_1");
		const territoryid3 = document.getElementById("territoryid3");
		const operatorid3 = document.getElementById("operatorid3");
		const promoterName3 = document.getElementById("promoterName3");
		...
		switchSecondLevel.addEventListener("change", function() {
			if (switchSecondLevel.checked) {
				territoryid3.required = true;
				operatorid3.required = true;
				promoterName3.required = true;
				appTSInfo3.required = true;
			} else {
				territoryid3.required = false;
				operatorid3.required = false;
				promoterName3.required = false;
