...
<title>View App Campaign Details</title>
		...
		<div class="page-content form-page">
			...
			<div class="bg-dash-dark-2 py-4">
				<div class="container-fluid">
					<h2 class="h5 mb-0">View App Campaign Details</h2>
				</div>
			</div>
			<!-- Breadcrumb-->
				...
				<div class="row gy-4">
					...
					<div class="card mb-0">
						<div class="card-header">
							<h3 class="h4 mb-0">List of all App Campaign Details</h3>
						</div>
						<div class="card-body pt-0">
							...
							<div class="table-responsive">
								<table class="table mb-0 table-striped table-hover"
									...
									<tbody>
										<c:forEach items="${appCampaignDetailsList}"
											var="appCampaignDetails">
											<tr class="dataRow">
												<th scope="row">${appCampaignDetails.id}</th>
												<td>${appCampaignDetails.campaign_name}</td>
												<td>${appCampaignDetails.operatorid}</td>
												<td>${appCampaignDetails.partnerid}</td>
												<td>${appCampaignDetails.territoryid}</td>
												<td>${appCampaignDetails.initials}</td>
												<td><form action="editAppCampaignDetails" method="post">
														<button class="btn btn-primary" type="submit"
															name="appCampaignId" value="${appCampaignDetails.id}">Edit</button>
													</form></td>
											</tr>
										</c:forEach>
									</tbody>
