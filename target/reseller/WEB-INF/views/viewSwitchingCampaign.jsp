...
<title>View Switching Campaign</title>
		...
		<div class="page-content form-page">
			...
			<div class="bg-dash-dark-2 py-4">
				<div class="container-fluid">
					<h2 class="h5 mb-0">View Switching Campaign</h2>
				</div>
			</div>
			<!-- Breadcrumb-->
				...
				<div class="row gy-4">
					...
					<div class="card mb-0">
						<div class="card-header">
							<h3 class="h4 mb-0">List of all Switching Campaign</h3>
						</div>
							...
							<div class="table-responsive">
								<table class="table mb-0 table-striped table-hover"
									...
									<thead>
										<tr>
											<th>ID</th>
											<th>Switching Name</th>
											<th>Switching Campaign ID</th>
											<th>First Level Campaign ID</th>
											<th>Second Level Campaign ID</th>
											<th>Created By</th>
											<th>Operator ID</th>
											<th>Action</th>
										</tr>
									...
									<tbody>
										<c:forEach items="${switchingCampaignList}"
											var="switchingCampaign">
											<tr class="dataRow">
												<th scope="row">${switchingCampaign.id}</th>
												<td>${switchingCampaign.switchingName}</td>
												<td>${switchingCampaign.switchingCampId}</td>
												<td>${switchingCampaign.switchingCampId_1}</td>
												<td>${switchingCampaign.switchingCampId_2}</td>
												<td>${switchingCampaign.createdBy}</td>
												<td>${switchingCampaign.operatorid}</td>
												<td><form action="editSwitchingCampaign" method="post">
														<button class="btn btn-primary" type="submit"
															name="switchingCampaignId"
															value="${switchingCampaign.id}">Edit</button>
													</form></td>
											</tr>
										</c:forEach>
									</tbody>
