...
<body>
	<div class="login-page">
					...
					<div class="row gx-0 align-items-stretch">
						...
						<div class="col-lg-6">
							<div
								...
								<div class="py-5">
									<h1 class="display-6 fw-bold">Reseller Login</h1>
									<p class="fw-light mb-0">Please login to continue</p>
								</div>
							</div>
						</div>
						<!-- Form Panel    -->
							...
							<div
								...
								<form class="login-form py-5 w-100" method="post"
									...
									<div class="input-material-group mb-3">
										<input class="input-material" id="username" type="text"
											name="username" autocomplete="off" required
											data-validate-field="loginUsername"> <label
											class="label-material" for="login-username">Username</label>
									</div>
									<div class="input-material-group mb-4">
										<input class="input-material" id="password" type="password"
											name="password" required data-validate-field="loginPassword">
									...
									<br> <a class="text-sm text-paleBlue" href="#">Forgot
										Password?</a><br> <small class="text-gray-500">Do not
										have an account? </small><a class="text-sm text-paleBlue"
		...
		<!-- <div
			class="login-footer text-center position-absolute bottom-0 start-0 w-100">
			<p class="text-white">
