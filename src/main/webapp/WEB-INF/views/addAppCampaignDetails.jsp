...
<title>Add App Campaign Details</title>
		...
		<div class="page-content form-page">
			...
			<div class="bg-dash-dark-2 py-4">
				<div class="container-fluid">
					<h2 class="h5 mb-0">Add App Campaign Details</h2>
				</div>
			</div>
			<!-- Breadcrumb-->
					...
					<div class="col-lg-12">
						...
						<div class="card">
							...
							<div class="card-body pt-0">
								<form class="form-horizontal" action="insertAppCampaignDetails"
									method="post">
									<div class="row">
									...
									<div class="row">
										...
										<div class="col-sm-9">
											<input class="form-control" type="number" name="pinlength"
												placeholder="Enter Pin Length Here..." min="4" max="6"
												required>
										</div>
									</div>
									<div class="my-4"></div>
