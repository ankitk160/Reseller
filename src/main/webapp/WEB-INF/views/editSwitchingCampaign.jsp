...
<body>
						...
						<div class="card">
							...
							<div class="card-body pt-0">
								<form class="form-horizontal" id="myForm"
									action="updateSwitchingCampaign" method="post">
									<div class="row">
									...
									<div class="row">
										...
										<div class="col-sm-9">
											<select class="form-select mb-3" id="territoryid" required>
												<c:forEach items="${territoryList}" var="territory">
													<option value="${territory.id}"
														<c:if test="${operator.territoryid == territory.id}">selected</c:if>>${territory.id}-
									...
									<div class="row">
										...
										<div class="col-sm-9">
											<select class="form-select mb-3" id="promoterName" required>
												<c:forEach items="${promoterList}" var="promoter">
													<option value="${promoter.name}"
														<c:if test="${promoter.name == promoterName}">selected</c:if>>${promoter.id}-
										...
										<div class="col-sm-9">
											<div class="form-check form-switch">
												<input class="form-check-input" type="checkbox"
													...
													<c:if test="${switchingCampaign.switchBaseCampaignFlag == 1}">checked</c:if>>
											</div>
										</div>
										...
										<div class="col-sm-9">
											<div class="form-check form-switch">
												<input class="form-check-input" type="checkbox"
													...
													<c:if test="${switchingCampaign.switchCampaignFlag_1 == 1}">checked</c:if>>
											</div>
										</div>
	...
	<script src="/reseller/resources/js/edit-switching-campaign.js"></script>
	<script>
		// ------------------------------------------------------- //
		//   Inject SVG Sprite - 
		//   see more here 
	...
	<script type="text/javascript">
		var operatorData = ${operator.id};
		var switchingData = {'switchingCampId': ${not empty switchingCampaign.switchingCampId ? switchingCampaign.switchingCampId : 'null'},
				'switchingCampId_1': ${not empty switchingCampaign.switchingCampId_1 ? switchingCampaign.switchingCampId_1 : 'null'},
				'switchingCampId_2': ${not empty switchingCampaign.switchingCampId_2 ? switchingCampaign.switchingCampId_2 : 'null'}};
	</script>
