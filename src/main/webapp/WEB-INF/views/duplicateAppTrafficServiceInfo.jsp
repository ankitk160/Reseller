...
<title>Create Duplicate App Traffic Service Info</title>
		...
		<div class="page-content form-page">
			...
			<div class="bg-dash-dark-2 py-4">
				<div class="container-fluid">
					<h2 class="h5 mb-0">Duplicate App Service Traffic Info</h2>
				</div>
			</div>
			<!-- Breadcrumb-->
			<div class="container-fluid py-2">
				...
				<ol class="breadcrumb mb-0 py-3 px-0">
					...
					<li class="breadcrumb-item active" aria-current="page">Duplicate
					...
					<div class="col-lg-12">
						<div class="card">
							...
							<div class="card-body pt-0">
								<form class="form-horizontal" action="duplicateATSInfo"
									method="post">
									<input type="hidden" value="${appTrafficServiceInfo.id}"
										name="id"> <input type="hidden"
										value="${appTrafficServiceInfo.optimizeFlag}"
										name="optimizeFlag"> <input type="hidden"
										value="${appTrafficServiceInfo.associationType}"
										name="associationType">
									<div class="row">
										<label class="col-sm-3 form-label">Optimize %age</label>
										<div class="col-sm-9">
											<input class="form-control" type="number"
												value="${appTrafficServiceInfo.optimizePerc}" min="0"
												step="10" max="100" name="optimizePerc" required>
										</div>
									</div>
									<div class="my-4"></div>
									<div class="row">
										...
										<div class="col-sm-9">
											<div class="input-group mb-3">
												<span class="input-group-text">$</span><span
													...
													placeholder="${appTrafficServiceInfo.price}" name="price"
													value="${appTrafficServiceInfo.price}" readonly required>
											</div>
										</div>
									</div>
									<div class="my-4"></div>
										...
										<div class="col-sm-9">
											<div class="input-group mb-3">
												<span class="input-group-text">$</span><span
													...
													class="form-control" type="number"
													value="${appTrafficServiceInfo.bidrate}"
													placeholder="${appTrafficServiceInfo.bidrate}"
													name="bidrate" readonly required>
											</div>
										</div>
									</div>
									<div class="my-4"></div>
									<div class="row">
										<label class="col-sm-3 form-label">Partner ID</label>
										<div class="col-sm-9">
											<input class="form-control" type="text"
												value="${appTrafficServiceInfo.partnerid}"
												placeholder="${appTrafficServiceInfo.partnerid}"
												name="partnerid" readonly required>
										</div>
									</div>
									<div class="my-4"></div>
									<div class="row">
										<label class="col-sm-3 form-label">Select Promoter
											Name</label>
										<div class="col-sm-9">
											<select class="form-select mb-3" name="PromoterName" required>
												<c:forEach items="${promoterList}" var="promoter">
													<option value="${promoter.id}"
														<c:if test="${promoter.name == appTrafficServiceInfo.promoterName}">selected</c:if>>${promoter.id}-
