		...
		<div class="page-content form-page">
			...
			<div class="bg-dash-dark-2 py-4">
				<div class="container-fluid">
					<h2 class="h5 mb-0">View Partner</h2>
				</div>
			</div>
			<!-- Breadcrumb-->
				...
				<div class="row gy-4">
					...
					<div class="card mb-0">
						<div class="card-header">
							<h3 class="h4 mb-0">List of all Partners</h3>
						</div>
									...
									<tbody>
										<c:forEach items="${partnerList}" var="partner">
											<tr class="dataRow">
												...
												<td>${partner.name}</td>
												<td>${partner.initials}</td>
												<td><form action="editPartner" method="post">
														<button type="submit" class="btn btn-primary"
															name="partnerId" value="${partner.id}">Edit</button>
													</form></td>
											</tr>
										</c:forEach>
										<!-- <tr>
