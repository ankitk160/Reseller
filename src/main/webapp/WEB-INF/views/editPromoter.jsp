		...
		<div class="page-content form-page">
			...
			<div class="bg-dash-dark-2 py-4">
				<div class="container-fluid">
					<h2 class="h5 mb-0">Edit Promoter</h2>
				</div>
			</div>
			<!-- Breadcrumb-->
					...
					<div class="col-lg-12">
						<div class="card">
							...
							<div class="card-body pt-0">
								<form class="form-horizontal" action="updatePromoter"
									method="get">
									<div class="row">
										<label class="col-sm-3 form-label">Name</label>
										<div class="col-sm-9">
											<input class="form-control" name="name" type="text"
												placeholder="Enter Name here..." value="${promoter.name}"
												required>
										</div>
									</div>
									<input type="hidden" name="id" value="${promoter.id}">
									<div class="my-4"></div>
									<input type="hidden" name="addtime" value="${promoter.addtime}">
									<div class="row">
										<label class="col-sm-3 form-label">Promoter Initials</label>
										<div class="col-sm-9">
											<input class="form-control" value="${promoter.initials}"
												name="initials" type="text"
												placeholder="Enter Promoter Initials Here..." required>
										</div>
									</div>
									<div class="my-4"></div>
									<div class="row">
