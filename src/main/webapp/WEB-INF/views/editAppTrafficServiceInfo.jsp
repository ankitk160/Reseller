...
<title>Edit App Service Traffic Info</title>
...
<body>
		...
		<div class="page-content form-page">
			...
			<div class="bg-dash-dark-2 py-4">
				<div class="container-fluid">
					<h2 class="h5 mb-0">Edit App Service Traffic Info</h2>
				</div>
			</div>
			<!-- Breadcrumb-->
										...
										<div class="col-sm-9">
											<div class="input-group mb-3">
												<span class="input-group-text">$</span><span
													...
													value="${appTrafficServiceInfo.price}" name="price" min="0"
										...
										<div class="col-sm-9">
											<div class="input-group mb-3">
												<span class="input-group-text">$</span><span
													...
													class="form-control" type="number"
													value="${appTrafficServiceInfo.bidrate}" name="bidrate"
										...
										<div class="col-sm-9">
											<select class="form-select mb-3" name="territoryid"
												...
												<c:forEach items="${territoryList}" var="territory">
													<option value="${territory.id}" <c:if test="${territory.name == territoryName}">selected</c:if> >${territory.id}-
	...
	<script src="/reseller/resources/js/edit-apptraffic-service-info.js"></script>
	<script>
		// ------------------------------------------------------- //
		//   Inject SVG Sprite - 
		//   see more here 
	...
	var appTSInfoData = ${appTrafficServiceInfo.operatorid};
	</script>
