...
<title>Edit App Campaign Details</title>
...
<body>
		...
		<div class="page-content form-page">
			...
			<div class="bg-dash-dark-2 py-4">
				<div class="container-fluid">
					<h2 class="h5 mb-0">Edit App Campaign Details</h2>
				</div>
			</div>
			<!-- Breadcrumb-->
					...
					<div class="col-lg-12">
						<div class="card">
							<div class="card-header">
								<h3 class="h4 mb-0">Edit below fields</h3>
							</div>
							<div class="card-body pt-0">
								<form class="form-horizontal" action="updateAppCampaignDetails"
									method="post">
									<div class="row">
										<label class="col-sm-3 form-label">Campaign Name</label>
										<div class="col-sm-9">
											<input class="form-control" type="text" name="campaign_name"
												value="${appCampaignDetails.campaign_name}"
												placeholder="Enter Campaign Name Here..." required>
										</div>
									</div>
									<input type="hidden" value="${appCampaignDetails.id}" name="id">
									<div class="my-4"></div>
									<div class="row">
											...
											<select class="form-select mb-3" name="territoryid"
												...
												<c:forEach items="${territoryList}" var="territory">
													<option value="${territory.id}"
														<c:if test="${territory.id == appCampaignDetails.territoryid}">selected</c:if>>${territory.id}-
									...
									<div class="my-4"></div>
									<div class="row">
										<label class="col-sm-3 form-label">Select Partner ID</label>
										<div class="col-sm-9">
											<select class="form-select mb-3" name="partnerid" required>
												<c:forEach items="${partnerList}" var="partner">
													<option value="${partner.id}"
														<c:if test="${partner.id == appCampaignDetails.partnerid}">selected</c:if>>${partner.id}-
														${partner.name}</option>
												</c:forEach>
											</select>
										</div>
									...
									<div class="my-4"></div>
									<div class="row">
										<label class="col-sm-3 form-label">Keyword</label>
										<div class="col-sm-9">
											<input class="form-control" type="text" name="keyword"
												value="${appCampaignDetails.keyword}"
												placeholder="Enter Keyword Here..." required>
										</div>
									</div>
									<div class="my-4"></div>
									<div class="row">
										<label class="col-sm-3 form-label">Short Code</label>
										<div class="col-sm-9">
											<input class="form-control" type="text"
												value="${appCampaignDetails.shortcode}" name="shortcode"
												placeholder="Enter Short Code Here..." required>
										</div>
									</div>
									<div class="my-4"></div>
									<div class="row">
										<label class="col-sm-3 form-label">Pin Length</label>
										<div class="col-sm-9">
											<input class="form-control" type="number"
												value="${appCampaignDetails.pinlength}" name="pinlength"
												min="4" max="6" placeholder="Enter Pin Length Here..."
												required>
										</div>
									</div>
									<div class="my-4"></div>
										...
										<div class="col-sm-9">
											<div class="input-group mb-3">
												<span class="input-group-text">$</span><span
													...
													value="${appCampaignDetails.price}" name="price" min="0"
													value="0" step=".001" required>
											</div>
										</div>
									</div>
									<div class="my-4"></div>
									<div class="row">
										<label class="col-sm-3 form-label">Validity</label>
										<div class="col-sm-9">
											<input class="form-control" type="number"
												value="${appCampaignDetails.validity}" name="validity"
												placeholder="Enter Validity Here..." required>
										</div>
									</div>
									<div class="my-4"></div>
									<div class="row">
										<label class="col-sm-3 form-label">Campaign Initials</label>
										<div class="col-sm-9">
											<input class="form-control" type="text"
												value="${appCampaignDetails.initials}" name="initials"
												placeholder="Enter Campaign Initials Here..." required>
										</div>
									</div>
									<div class="my-4"></div>
									<div class="row">
	...
	<script src="/reseller/resources/js/edit-campaign-details.js"></script>
	<script>
		// ------------------------------------------------------- //
		//   Inject SVG Sprite - 
		//   see more here 
	...
	<script type="text/javascript">
		var campaignData = ${appCampaignDetails.operatorid};
	</script>
